...
class build_adjacency_matrix:
    def __init__(self, labeled_pdb_dir='data/directory_reformulate_combined/',
                 out_adjacency_dir='graph/directory_graph_connection/',
                 out_interaction_dir='graph/directory_graph_interaction/', threshold_carbon=1.65,
